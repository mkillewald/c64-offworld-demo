;============================================================
; Offworld Demo
; Code by Mike Killewald aka k1ds3ns4t10n/The Kommodore Krew (TKK)
; Graphics originally by Don Behm and converted by Mike Killewald 
; Music by ole marius petterson of prosonix
;
; (c) 2017
;
;============================================================
...
!cpu 6502
!to "build/offworld.prg",cbm    ; output file
...
;============================================================
;    subroutines called repeatly during custom ISR
;============================================================

!source "code/sub_update_sprite.asm"
!source "code/sub_scroll.asm"
