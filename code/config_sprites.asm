...
sprite_pointer_skull = address_sprites / $40
...
sta $d017	; set y expansion
sta $d01d	; set x expansion
...
sta $d000    ; sprite0 X-Coord (0-504 incl 9th Bit on PAL systems)
lda #$67
sta $d001    ; sprite0 Y-Coord (0-255 on PAL systems)
...
lda #sprite_color_skull	 	 ; individual Sprite#0 color
sta $d027
